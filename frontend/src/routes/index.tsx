      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            ...
            and productive. Create, track, and complete your tasks effortlessly.
          </p>
            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600">
                  Clean interface that makes task management a breeze. No
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600">
                  Quick load times and snappy interactions. Your tasks are
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600">
                  Your data is encrypted and protected. We take your privacy
                  seriously.
                </p>
              </div>
            </CardContent>
